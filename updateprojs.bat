...
rem file build.sbt
set _GRAALVM_VERSION_OLD="19.1.1"
set _GRAALVM_VERSION_NEW="19.2.0"

set _POM_GRAALVM_VERSION_OLD="19.1.1-SNAPSHOT"
set _POM_GRAALVM_VERSION_NEW="19.2.0-SNAPSHOT"
